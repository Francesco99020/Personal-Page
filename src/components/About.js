...
const WebDevelopmentData = [
    { bgcolor: "#F09601", percentComplete: 40, experience: '(HTML) 2 Years', image: html5, showProgress: true, imageClasses: 'd-block' },
    { bgcolor: "#34BDEC", percentComplete: 40, experience: '(CSS) 2 Years', image: css3, showProgress: true, imageClasses: 'd-block' },
    { bgcolor: "#F7DF1E", percentComplete: 40, experience: '(JavaScript) 2 Years', image: javascript, showProgress: true, imageClasses: 'd-block'  },
    { bgcolor: "#135795", percentComplete: 25, experience: '(TypeScipt) 1 Year', image: typescript, showProgress: true, imageClasses: 'd-block'  },
    { bgcolor: "#80DEEA", percentComplete: 20, experience: '(React) 6 Months', image: reactNative, showProgress: true, imageClasses: 'd-block'  },
  ...
  const TeamWorkFlowData = [
    {bgcolor: "#404040", percentComplete: 60, experience: '(GitHub) 3 Years', image: github },
    ...
    return(
        <div id='about' className="About-Container">
            <div className='My-Advertizing'>
                <h1>I am an extremly dedicated programer who loves to work on all aspects of web development. If you are looking for a generalist to help with all parts of your project then i'm your guy.</h1>
            </div>
            <div className="About-Me">
                <h1 className="About-heading-1">About Me</h1>
                <p className="About-p-1">I grew up in a small town of Baldwin, located inside NY, Long Island.
                    I Graduated High School from Baldwin Senior High School. Now, I am a senior attend New York Institute of Technology
                    ...
                    web development, Video game development and augmented reality. On the right you can look at some popular
                     softwares I know and check out how long I have been using them!
                </p>
            </div>
